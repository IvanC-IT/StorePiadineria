...
public class JwtTokenUtil implements Serializable {
	...
	@Value("${jwt.totem.expiration}")
	private Long expirationTotem;
	...
	public String generateToken(UserDetails userDetails) throws JsonProcessingException {
		...
		if (auth.contains("ROLE_TOTEM"))
			claims.put(CLAIM_EXPIRATION, System.currentTimeMillis() + expirationTotem * 1000);
		else
			claims.put(CLAIM_EXPIRATION, System.currentTimeMillis() + expiration * 1000);
